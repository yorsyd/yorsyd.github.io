...
<body>
	...
	<div class="about">
		...
		<div class="about-text">
			...
			<p>
				<b>Urbane Threads</b> adalah sebuah toko sepatu yang menghadirkan gaya modern dan urban kepada para penggemar mode. 
				Dengan koleksi yang beragam, menawarkan sepatu-sepatu berkualitas tinggi yang dirancang untuk memenuhi kebutuhan 
				gaya hidup perkotaan yang aktif dan trendi. Kami percaya bahwa sepatu adalah aksesoris penting dalam mengekspresikan 
				identitas dan gaya pribadi seseorang. Setiap produk yang kami tawarkan dipilih dengan hati-hati dari merek-merek terkenal dan 
				pabrikan yang terpercaya, sehingga Anda dapat yakin akan mendapatkan sepatu yang tahan lama dan nyaman.</p>
		</div>
	</div>
